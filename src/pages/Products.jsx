...
import { deleteProduct, readAllData } from "../apis/curd-ops";
...
const Products = () =>  {
    ...
    return(
      ...
      <button onClick={navigateToAddition}  style={{ fontSize: 48, float: "right", position: "absolute", right: 0, top:0 }}>+</button>
      {prods.map((product) => (
